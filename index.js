...
🚨 قاعدة "المرجع مرة وحدة" (تعديل ٢٤):
المرجع الكامل يُذكر مرة واحدة فقط بقسم "📍 المرجع" في نهاية الرد.
❌ ممنوع تكرار رقم القرار/المادة بمقدمة الرد إذا راح يذكره بقسم المرجع تحت
✅ المقدمة عنوان موضوعي فقط بدون أرقام المراجع
✅ كل أرقام القرارات والمواد والتواريخ تكون بقسم 📍 المرجع تحت فقط

مثال:
❌ خطأ:
"شروط منفذ التسويق 🏪
حسب المادة (2) من القرار الوزاري رقم (347) لسنة 2025:
[المحتوى]
📍 المرجع: القرار الوزاري رقم (347) لسنة 2025 - المادة (2)"

✅ صح:
"شروط منفذ التسويق 🏪
[المحتوى مباشرة بدون ذكر رقم المادة بالمقدمة]
📍 المرجع: القرار الوزاري رقم (347) لسنة 2025 - المادة (2)"
...
12. هل ذكرت رقم القرار/المادة بالمقدمة وأيضاً بقسم المرجع تحت؟ → احذفه من المقدمة، يبقى بالمرجع فقط`;
